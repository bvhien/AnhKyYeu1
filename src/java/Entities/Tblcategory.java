...
public class Tblcategory  implements java.io.Serializable {
    ...
    public Tblcategory(String categoryName, short categorySectionId, String categoryNotes, String categoryCreatedDate, Integer categoryCreatedAuthorId, String categoryLastModified, Integer categoryManagerId, Boolean categoryEnable, Boolean categoryDelete, String categoryImage, String categoryNameEn, Short categoryLanguage) {
       this.categoryName = categoryName;
       this.categorySectionId = categorySectionId;
